...
def main() -> None:
    parser = argparse.ArgumentParser(description="CMAPSS RUL with SafeLoop weighting.")
    ...
    alpha_head = ResidualAlpha(in_dim=x.shape[2]).to(device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print(
            f"epoch {epoch:02d} | weighted mse {total / max(1, len(train_loader)):.4f} | "
